...
# ==============================================================================
# pmesh = MeshExtended(cloud_instance=True, cloud_dkey='mesh', cloud_port=9001)
# print(type(pmesh))
# print(pmesh)
...
# ==============================================================================
mesh = MeshExtended(cloud_autosolve=True, cloud_port=9001)
# class MeshExtended(CloudBase, Mesh):
...
# ==============================================================================
mesh = MeshExtended()
pmesh = mesh.to_cloud(cloud_dkey='mesh', cloud_port=9001)
